...
class MedGemmaSetup:
    ...
    def check_env_file(self):
        ...
        if "hf_xxx" in env_content or "HF_TOKEN=" not in env_content:
            print("⚠️ HF_TOKEN non configurato in .env")
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                if cuda_available and gpu_name != 'None':
                    ...
                    print("⚠️ GPU non disponibile (modalità CPU)")
                return True
            else:
                print("⚠️ PyTorch non ancora installato nel venv")
                return False
                
        except Exception as e:
            print(f"⚠️ Errore verifica GPU: {e}")
            return False
...
"""
        ...
        try:
            ...
            print(f"⚠️ Errore generazione script: {e}")
            return False
...
"""
        ...
        try:
            ...
            print(f"⚠️ Errore generazione script run: {e}")
            return False
